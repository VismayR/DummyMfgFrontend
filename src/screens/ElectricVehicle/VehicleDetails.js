...
import {CAR_MODEL, CAR_NAME, CAR_PRICE, CAR_VIN, SELECT_VEHICLE_BTN} from '../../constant/ElectricVehicle';
      ...
      <View style={styles.detailView}>
        {CARS.filter(item => item.id === route.params.id).map(res => (
          <View>
            ...
            <Text style={[styles.textPositions,styles.title]}>{CAR_MODEL}</Text>
            ...
            <Text style={[styles.textPositions,styles.title]}>{CAR_PRICE}</Text>
